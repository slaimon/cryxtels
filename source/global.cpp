...
bool fid = false; // Flag: Orientamento nella direzione opposta a quella corrente...
bool lead = false; // Flag: Orientamento in direzione d'avanzamento...
bool orig = false; // Flag: Orientamento in direzione del Solicchio...
u8 comera_m;
