...
extern bool fid; // Flag: Orientation of the direction opposite to the current one...
extern bool lead; // Flag: Orientation of the leading direction...
extern bool orig; // Flag: Orientation towards Sunny (Solicchio)...
